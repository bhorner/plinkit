...
-->
				...
				<div id="featured" class="width-65 column left" data-sticky_column>
					...
					<div class="featured-item">
						...
						<div class="author-div">
							<p class="upper"><a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ), get_the_author_meta( 'user_nicename' ) ); ?>"><?php echo the_author_meta('first_name');?> <?php echo the_author_meta('last_name');?></a><?php if(get_the_author_meta('title')){?>,  <span class=""><i><?php echo the_author_meta('title');?></i></span><?php }?></p>
						</div>	
					...
					<div class="post-footer">
						...
						<div class="author">
							...
							<?php
							    ...
							    $headshot = mt_profile_img( $author_id, array(
							        'size' => 'thumbnail',
							        'echo' => false )
							    );
							    if($headshot != '') {
								    echo '<div class="user-thumbnail">';
								    echo $headshot;
								    echo '</div>';
							    }
							?>
						...
						?>
						    <div class="author">
								<?php
								$second_author = get_sub_field('author');
								$second_author = $second_author['ID'];
								?>
								...
								?>
								<?php
								    $headshot = mt_profile_img( $second_author, array(
								        'size' => 'thumbnail',
								        'echo' => false )
								    );
								    if($headshot != '') {
								...
								<div class="bio">
									<p class="upper"><a href="<?php echo get_author_posts_url($second_author, get_the_author_meta( 'user_nicename', $second_author ) ); ?>"><?php echo the_author_meta('first_name', $second_author);?> <?php echo the_author_meta('last_name', $second_author);?></a><?php if(get_the_author_meta('title', $second_author)){?>,  <span class=""><i><?php echo the_author_meta('title', $second_author);?></i></span><?php }?></p>
			 						<p><?php $authorDesc = the_author_meta('description', $second_author); echo $authorDesc; ?>	</p>
								</div>	
							</div>
						<?php
						    endwhile;
	...
	?>		
	<?php
		$post_objects = get_field('works_well_with_2');
		if( $post_objects ): ?>
