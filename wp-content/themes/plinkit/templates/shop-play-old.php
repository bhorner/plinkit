<?php
/*
 * Template Name: OLD Shop + Play Page
...
<!-- 			<a class="link" href="<?php the_permalink('2983'); ?>" target="_blank"><?php the_field('tagline');?></a> -->
...
<div class="band ">
    <div class="container">
		<div class="header bg-coral">Critical Thinking</div>
		...
		<div class="excerpt width-100 column left">	
			...
			<?php
				...
				<?php } ?>
					...
					<div class="cat-tags
					<?php
						$toy_assigned_terms = wp_get_post_terms($id, 'skills-toys', array("fields" => "all"));
...
<div class="band ">
    <div class="container">
		<div class="header bg-teal">Social + Emotional</div>
	<div class="owl-carousel">
	<?php foreach ( $myposts as $post ) : setup_postdata( $post );?>
...
<div class="band ">
    <div class="container">
		<div class="header bg-coral">Language + Literacy</div>
<div class="owl-carousel">
	<?php foreach ( $myposts as $post ) : setup_postdata( $post );?>
...
<div class="band ">
    <div class="container">
		<div class="header bg-teal">Creativity + Imagination</div>
<div class="owl-carousel">
	<?php foreach ( $myposts as $post ) : setup_postdata( $post );?>
...
<div class="band ">
    <div class="container">
		<div class="header bg-coral">Fine Motor + Gross Motor</div>
<div class="owl-carousel">
	<?php foreach ( $myposts as $post ) : setup_postdata( $post );?>
...
<div class="band ">
    <div class="container">
		<div class="header bg-teal">Wow Factor</div>
<div class="owl-carousel">
	<?php foreach ( $myposts as $post ) : setup_postdata( $post );?>
